...
IF OBJECT_ID(N'dbo.AdHocManager', N'U') IS NOT NULL
  DROP TABLE [dbo].[AdHocManager];
IF OBJECT_ID(N'dbo.Employee', N'U') IS NOT NULL
  DROP TABLE [dbo].[Employee];
IF OBJECT_ID(N'dbo.EmployeeOrgPermissions', N'V') IS NOT NULL
  DROP VIEW [dbo].[EmployeeOrgPermissions];
...
CREATE TABLE [dbo].[AdHocManager]
(
    [AdHocManagerId] INT NOT NULL IDENTITY,
    [EmployeeId] INT NOT NULL,
    [AppliesToOrg] BIT NOT NULL
);
...
INSERT INTO [dbo].[Employee] ([EmployeeId], [LastName], [FirstName], [Title], [ReportsTo], [Email]) VALUES (10, N'Smith', N'Robin', N'Management Consultant', 1, N'robin@chinookpublic.com');
INSERT INTO [dbo].[Employee] ([EmployeeId], [LastName], [FirstName], [Title], [ReportsTo], [Email]) VALUES (11, N'Jones', N'Sam', N'Management Consultant', 1, N'sam@chinookpublic.com');
SET IDENTITY_INSERT [dbo].[Employee] OFF;

SET IDENTITY_INSERT [dbo].[AdHocManager] ON;
INSERT INTO [dbo].[AdHocManager] ([AdHocManagerId], [EmployeeId], [AppliesToOrg]) VALUES (10, 2, 0);
INSERT INTO [dbo].[AdHocManager] ([AdHocManagerId], [EmployeeId], [AppliesToOrg]) VALUES (11, 6, 1);
SET IDENTITY_INSERT [dbo].[AdHocManager] OFF;
